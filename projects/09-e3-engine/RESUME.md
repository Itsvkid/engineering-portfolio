...
2. **Stage J, continued.** J1 (the meridional plot) is done —
   ...
   J2 (the Campbell match) and J3 (the glTF, `exports/e3-blading.glb`)
   are done too. What is left in J is the README, the drawing pack, the
   site cutaway, `projects/README.md` and the post.
