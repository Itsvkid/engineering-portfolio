...
| **`e3-hp-compressor-detail-design.pdf`** | 19850002690 | **Table X per-stage rotor summary; Table XXI stator vector diagrams and geometry; Table XXII rotor section geometry**; Campbell diagrams all stages; clearances; casing bolting; dovetails; **Fig. 30 p.59 (PDF 68) "Rotor Design Features" — the whole ten-stage rotor in section: bores, webs, rims, stub shaft, the one bolt joint, the 3-tooth CDP seal. Undimensioned, and dimensionable against the published annulus (unit E11)** |
