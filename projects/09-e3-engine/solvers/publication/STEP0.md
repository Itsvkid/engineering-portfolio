...
`exports/e3-blading.glb`, **3.96 MB**, from `solvers/publication/render.py`.
Preview at `figures/blading-meridional.png`. It was 4.7 MB until J7
narrowed each row's indices to uint16 where the vertex count allows it —
lossless, and all 32 rows qualify.
