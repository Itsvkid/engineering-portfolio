...
There is no basic-engine mass here, because F2's closure is gated on disc
profiles of which unit E11 has read only the bore line -- the webs and rims
are still un-digitised -- and on a bearing system the reports never
