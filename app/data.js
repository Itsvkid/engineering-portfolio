...
export const projects = [
  ...
  },
  {
    ...
    period: "Sep 2026",
    stats: [
      { value: "12", label: "Engine systems, 144 selectable parts" },
    ...
    figures: [
      {
        ...
        alt: "Cutaway of the turbofan from the front quarter with all twelve systems visible around the core: fan, compressor, combustor and turbines in metal tones, fuel, oil, air, control, ignition and fire hardware in colour.",
        short: "Cutaway, all systems",
        caption: "The default view: a wedge cutaway through the nacelle and core, every system on. The fan, booster, ten HPC stages, combustor, two HPT and five LPT stages are at the E\u00b3's published radii; the externals are placed where the reports put them.",
      },
      {
        src: "/figures/turbofan-atlas-fan-dark.png",
        srcLight: "/figures/turbofan-atlas-fan.png",
      ...
      },
      {
        ...
        srcLight: "/figures/turbofan-atlas-exploded.png",
        alt: "The engine separated along its axis with the casings faded to a quarter opacity, the rotors, combustor and external units spread out as a parts inventory.",
        short: "Separated",
        caption: "The separation control spreads the assembly along the axis and lifts the externals off the core, the equivalent of an anatomy atlas's parts inventory, with the casings faded so the rotors read through them.",
      },
    ],
  },
  {
    title: "ME TF0.01 \u2014 What Bypass Ratio 10 Costs on the Same Core",
    context: "My own derivative study, built on the validated E\u00b3 reconstruction",
    period: "Sep 2026",
    stats: [
      { value: "1.46", label: "Fan-to-turbine shaft speed ratio" },
      { value: "8", label: "LP turbine stages, against five" },
      { value: "3\u20134.5%", label: "Fuel burn, bounded" },
    ],
    points: [
      ...
      "The answer is not the fan. At the E\u00b3's own bypass ratio the fan wants 3,523 rpm and the turbine wants 3,548 \u2014 within a per cent, which is why the engine is a direct drive and a good one. At bypass ratio 10 the fan wants 2,510 and the turbine wants 3,673. Everything else is a way of paying that 46 per cent: more turbine stages, a faster fan tip, or a gearbox. A gear ratio of 1.46 to delete two stages is a bad trade when a real geared fan runs near 3 to 1 and exists for a much bigger speed gap, so the turbine is the cheaper answer here.",
      ...
      "Two results worth more than the headline. The quarter-stage island does not survive: the booster's loading nearly doubles and it becomes two stages, so the feature that throws ingested debris clear of the core is gone \u2014 the cheapest way to see what a derivative costs is to ask which published feature stops working. And blade stress never binds, because a bigger fan turns slower and root stress falls below the E\u00b3's; anyone reaching for AN\u00b2 first is answering the wrong question.",
